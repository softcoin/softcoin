...
uint256 hashGenesisBlock("0x35f28996ca2672f9d5af62fbb34f125b03b990ef79403c0a3ccdae56d50179f6");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // softcoin: 1 days
static const int64 nTargetSpacing = 120; // softcoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal softcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "softcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9ff65b12dd2554d8b2a28f672b1f735e2ce3d88beb30bbd3a35e59d539988ecc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1415520218; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2066583;

        if (fTestNet)
        {
            block.nTime    = 1415520218;
            block.nNonce   = 2911493;
        }
